return {
  {
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd("User", {
        pattern = "LazyReload",
        callback = function()
          -- ATUALIZADO: Aponta para a nova localização do tema
          local theme_module = "plugins.visual.theme"
          ...
          vim.schedule(function()
            ...
            -- Encontra o plugin de tema atual para descarregar
            ...
            -- Descarrega módulos do plugin do tema
            ...
            for _, spec in ipairs(theme_spec) do
              if spec[1] == "LazyVim/LazyVim" and spec.opts and spec.opts.colorscheme then
                ...
                vim.defer_fn(function()
                  ...
                  -- Recarrega transparência se existir
